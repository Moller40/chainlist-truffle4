...
// before every test file is executed the contract is redeployed
...
contract("ChainList", function(accounts){
  ...
  it("should throw an exception if you try to buy an article when there is no article for sale yet", function() {
    ...
    }).then(assert.fail) // Expecting failure is done like this, and then catch and assert(true)
  ...
  // incorrect value
  // Using the sellArticle from prev test case
